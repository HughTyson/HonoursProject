...
namespace Haze
{
    ...
    public static class Triangulator
    {
        ...
        {
            if (path.Count < 1) throw new System.ArgumentException("Path must have length 1 at least!");
        ...
        {
            if (polygon == null) throw new System.ArgumentNullException("Polygon cannot be null");
            if (point == null) throw new System.ArgumentNullException("Point cannot be null");
        ...
        {
            if (polygon == null) throw new System.ArgumentNullException("Polygon must not be null!");
            if (polygon.Count < 3) throw new System.ArgumentException("Polygon cannot have less than 3 vertices!");
            float sum = 0;
            for (int i = 0; i < polygon.Count; ++i)
            {
                Vector2 p1 = polygon[i];
        ...
        {
            if (tris == null) throw new System.ArgumentNullException("Tris is null; invalid operation.");
        ...
        {
            if (pathSource == null) throw new System.ArgumentNullException("PathSource must not be null!");
